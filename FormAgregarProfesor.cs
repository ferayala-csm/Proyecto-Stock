...
namespace ABM_presentacion
{
    ...
    {
        private readonly FormProfesores formProfesores;

        public FormAgregarProfesor(FormProfesores formProfesores)
        {
            InitializeComponent();
            this.formProfesores = formProfesores;
        }
